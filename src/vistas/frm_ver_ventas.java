...
public class frm_ver_ventas extends javax.swing.JInternalFrame {
    ...
    private void sumar_tabla() {
        ...
        for (int i = 0; i < t_ventas.getRowCount(); i++) {
            ...
            exonerado += (Double.parseDouble(t_ventas.getValueAt(i, 8).toString()));
            igv += (Double.parseDouble(t_ventas.getValueAt(i, 7).toString()));
            total += (Double.parseDouble(t_ventas.getValueAt(i, 9).toString()));
        }
        jTextField1.setText(c_varios.formato_totales(subtotal));
        jTextField2.setText(c_varios.formato_totales(igv));
        jTextField3.setText(c_varios.formato_totales(exonerado));
        jTextField5.setText(c_varios.formato_totales(total));
    }
    ...
    private void initComponents() {
        ...
        jToolBar2.add(btn_salir);

        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/magnifier.png"))); // NOI18N
        ...
        jDialog1Layout.setHorizontalGroup(
            ...
            .addGroup(jDialog1Layout.createSequentialGroup()
                ...
                .addComponent(jToolBar2, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jLabel7.setText("Total Exonerado:");
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        //abrir jdialog con id de venta seleccionada
